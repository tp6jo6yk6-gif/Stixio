...
|---|---|---|---|---|
| B-001 | Medium | Refine | Manual crop handles are not in the redesigned UI yet. | Known limitation |
...
| ID | Severity | Area | Issue | Fixed in |
|---|---|---|---|---|

## Notes

Beta 1 focuses on the Quick Project flow after the Core refactor and UI redesign.
