...
function getReviewCardBackgroundClass() { if (state.settings.reviewBackground === ReviewBackgrounds.WHITE) return 'bg-white'; if (state.settings.reviewBackground === ReviewBackgrounds.BLACK) return 'bg-slate-950'; if (state.settings.reviewBackground === ReviewBackgrounds.Sticker) return 'bg-[#06c755]'; return 'bg-[linear-gradient(45deg,#e2e8f0_25%,transparent_25%),linear-gradient(-45deg,#e2e8f0_25%,transparent_25%),linear-gradient(45deg,transparent_75%,#e2e8f0_75%),linear-gradient(-45deg,transparent_75%,#e2e8f0_75%)] bg-[length:14px_14px]'; }
